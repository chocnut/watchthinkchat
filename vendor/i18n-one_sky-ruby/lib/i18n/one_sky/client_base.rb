...
again to regenerate your config.
      ...
      def verify_options!(options)
        ...
        unless missing_keys.empty?
          fail ::ArgumentError, REQUIRED_KEYS_MESSAGE
        end
      end
      ...
      def verify_default_locale!
        if I18n.default_locale.to_s.downcase != locale_os_to_i18n(platform_base_locale).to_s.downcase
          fail DefaultLocaleMismatchError, "I18n and OneSky have different default locale settings. #{I18n.default_locale} <> #{platform_base_locale}"
        end
      end
