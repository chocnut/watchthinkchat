...
Devise.setup do |config|
  ...
  # session. If you need permissions, you should implement that
  # in a before filter.
  ...
  # passed to the find_for_authentication method and considered in your
  # model lookup. For instance,
  ...
  # re-encrypted.
  #
  # Limiting the stretches to just one in testing will
  ...
  # unconfirmed email column, and copied to email column on
  ...
  # above to 20 for default behavior)
  # and :restful_authentication_sha1 (then you should set stretches to 10,
  ...
  # Turn scoped views on. Before rendering 'sessions/new',
